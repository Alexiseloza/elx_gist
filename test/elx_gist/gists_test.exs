defmodule ElxGist.GistsTest do
  ...
  describe "gists" do
    ...
    @invalid_attrs %{name: nil, description: nil, markuo_text: nil}
    ...
    test "create_gist/1 with valid data creates a gist" do
      valid_attrs = %{name: "some name", description: "some description", markuo_text: "some markuo_text"}

      assert {:ok, %Gist{} = gist} = Gists.create_gist(valid_attrs)
      assert gist.name == "some name"
      assert gist.description == "some description"
      assert gist.markuo_text == "some markuo_text"
    end
    ...
    test "update_gist/2 with valid data updates the gist" do
      gist = gist_fixture()
      update_attrs = %{name: "some updated name", description: "some updated description", markuo_text: "some updated markuo_text"}
      ...
      assert gist.markuo_text == "some updated markuo_text"
    end
